package com.reactnativeturbolauncharguments

import android.content.Context.BATTERY_SERVICE
import android.os.BatteryManager
import com.facebook.react.bridge.*

class TurboLaunchArgumentsModule(reactContext: ReactApplicationContext?) :
    NativeTurboLaunchArgumentsSpec(reactContext) {
    ...
    companion object {
        const val NAME = "TurboLaunchArguments"

        init {
            System.loadLibrary("reactnativeturbolauncharguments-jni")
        }
    }
}
